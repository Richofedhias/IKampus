...
public class UnpadBeasiswa extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_unpad_beasiswa);
...
//    }
    ...
    public void daftarMahasiswa(){
        daftar.add(new BeasiswaList("Beasiswa 2019",R.drawable.beasiswa_jpu,"11 Februari 2019 s.d 27 April 2019","28 April 2019"));
        daftar.add(new BeasiswaList("Beasiswa 2019",R.drawable.beasiswa_fojb,"7 Januari 2019 s.d 9 Februari 2019","-"));
        daftar.add(new BeasiswaList("Beasiswa 2019",R.drawable.beasiswa_osc,"30 Agustus 2018 s.d 2 November 2018","4 November 2018"));
