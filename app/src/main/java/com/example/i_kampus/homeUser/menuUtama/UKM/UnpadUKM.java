...
public class UnpadUKM extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_unpad_ukm);

        database = FirebaseDatabase.getInstance().getReference("UKM");
        database.keepSynced(true);

        rv_ukm = findViewById(R.id.unpad_ukm);
    ...
    protected void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<Dbukm, UKMViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Dbukm, UKMViewHolder>(Dbukm.class, R.layout.list_ukm_item, UKMViewHolder.class , database) {
            @Override
            protected void populateViewHolder(UKMViewHolder viewHolder, Dbukm model, int position) {
                viewHolder.setImage(UnpadUKM.this,model.getGambarUkm());
